  ...
  return (
    <div className="mt-6 flex flex-wrap items-center gap-3">
      <RippleButton
        ...
        className={
          inStock
            ? "rounded-xl bg-[#2874f0] px-8 py-3 text-sm font-extrabold text-white shadow-[0_8px_24px_rgba(40,116,240,0.35)] transition hover:bg-[#1a65d8]"
            : "cursor-not-allowed rounded-xl bg-slate-200 px-8 py-3 text-sm font-bold text-slate-500"
        }
      >
        {t("addToCart")}
      </RippleButton>
      <Link
        href="/cart"
        className="rounded-xl border-2 border-[#2874f0]/30 bg-white px-8 py-3 text-sm font-bold text-[#2874f0] transition hover:bg-[#2874f0]/5"
      >
        {t("goToCart")}
      </Link>
      ...
      <button
        ...
        className={cn(
          "inline-flex items-center gap-2 rounded-2xl border-2 px-5 py-3 text-sm font-bold transition",
          has(productId)
