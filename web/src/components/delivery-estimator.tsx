    ...
    <div className="rounded-2xl border border-slate-200/90 bg-white/80 p-4 dark:border-slate-700/80 dark:bg-slate-900/40">
      ...
      <form onSubmit={onSubmit} className="mt-3 flex flex-wrap gap-2">
        <input
          ...
          className="min-w-[140px] flex-1 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-900 outline-none focus:border-[#0066ff] dark:border-slate-600 dark:bg-slate-950 dark:text-slate-100"
        />
        <button
          type="submit"
